...
/css/main.css" rel="stylesheet" type="text/css">
	<!--[if lt IE 7]>
		<link rel="stylesheet" type="text/css" href="templates/<?php echo $this->_tpl_vars['SKIN_NAME']; ?>
/css/style-ie.css" />
	<![endif]-->
	<link href="templates/<?php echo $this->_tpl_vars['SKIN_NAME']; ?>
...
/css/style-def.css" rel="stylesheet" type="text/css">
	<link href="templates/<?php echo $this->_tpl_vars['SKIN_NAME']; ?>
/css/invoice.css" rel="stylesheet" type="text/css">
	<link href="templates/<?php echo $this->_tpl_vars['SKIN_NAME']; ?>
/css/receipt.css" rel="stylesheet" type="text/css">
...
/css/popup.css" rel="stylesheet" type="text/css">
	...
	<script type="text/javascript">	
		var IMAGE_PATH = "templates/<?php echo $this->_tpl_vars['SKIN_NAME']; ?>
/images/";
	</script>
